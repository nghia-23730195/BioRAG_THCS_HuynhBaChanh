...
title BioRAG - Khoi dong mot cham

echo ==========================================
echo       BIORAG - KHOI DONG MOT CHAM
echo ==========================================
echo.
...
start "BioRAG Server" "%ComSpec%" /k ""%CD%\venv\Scripts\python.exe" "%CD%\main.py" --api --port %PORT%"
...
echo.
echo ==========================================
echo   BIORAG DA SAN SANG: http://127.0.0.1:%PORT%/
